...
@section('content')
    ...
    <form method="post" action="/update-product/{{ $product->id }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input name="image" type="file" id="productimageid" class="custom-file-input"> value={{ $product->image }}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input name="prijs" type="number" class="form-control" id="prijsid" value={{ $product->prijs }}
                       required value="{{ old('prijs') }}">
            </div>
        </div>
